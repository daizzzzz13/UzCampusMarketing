...
import 'screens/requirements_stepper_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/requirements_user_screen': (context) => RequirementsUserScreen(
        ...
        '/requirements_stepper': (context) => const RequirementsStepperScreen(
              jobId: 1, // Example default job ID
